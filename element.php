...
<body class="page" data-theme="">
	<div class="page-wrapper">
		...
		<main data-barba="wrapper" data-barba-namespace="element">
			<article data-barba="container" class="element">
				<div class="sec">
					<!-- <img src="./src/images/<?= $element->image; ?>" alt=""> -->
					<div style="background-image: url(./src/images/<?= $element->image; ?>);" class="image"></div>
					<section>
						<h2 class="flyOver"><?= $element->titre; ?></h2>
						<hr>
						<!-- <h2><?= formatNb($elementId); ?></h2> -->
						<h2 class="flyOver"><?= $element->artiste; ?></h2>
						<h2 class="flyOver"><?= $element->date; ?></h2>
					</section>
				</div>
